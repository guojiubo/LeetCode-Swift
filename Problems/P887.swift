...
class P887: XCTestCase {
    ...
    func testSuperEggDrop() {
        XCTAssertEqual(superEggDrop(4, 5000), 19)
        XCTAssertEqual(superEggDrop(1, 2), 2)
        XCTAssertEqual(superEggDrop(2, 6), 3)
        XCTAssertEqual(superEggDrop(3, 14), 4)
    }
